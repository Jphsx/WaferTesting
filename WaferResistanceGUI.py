...
class Window(Frame):
    ...
    def __init__(self, master=None, motorsPort='COM4', keithleyPort='COM13', emulate=False):
        ...
        self.ROCnumEntry = Entry(self, textvariable=self.ROCnumVar, width=15)
        ...
        self.GroupTypeEntry = Entry(self, textvariable=self.GroupTypeVar, width=15)
        ...
        self.BankNumEntry = Entry(self, textvariable=self.BankNumVar, width=15)
        ...
        self.ResNumEntry = Entry(self, textvariable=self.ResNumVar, width=15)
